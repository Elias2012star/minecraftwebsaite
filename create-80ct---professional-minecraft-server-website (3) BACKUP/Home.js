      ...
      <section className="relative px-6 pb-20 -mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center border-t border-gray-100 pt-12 w-full max-w-4xl mx-auto reveal">
          <div className="space-y-1 transition-transform hover:scale-105 duration-300 cursor-default flex flex-col items-center">
            <div className="text-5xl font-black text-blue-500">17</div>
          ...
          >
            <div className="text-2xl font-black text-gray-900 py-1 group-hover:text-blue-600 transition-colors uppercase">stablesv.falix.gg</div>
            <div className="text-[10px] text-gray-400 uppercase tracking-[0.4em] font-bold group-hover:text-blue-500">Server IP · Click to copy</div>
          </div>
          <div className="space-y-1 transition-transform hover:scale-105 duration-300 cursor-default flex flex-col items-center">
